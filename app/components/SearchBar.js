...
export default function SearchBar() {
  const { wordData, setActiveWord, fetchWordData } = useWordContext();
  ...
  return (
    <div className="flex justify-between items-center mb-8 h-[64px] min-w-[370px] md:w-[737px] bg-[#F4F4F4] rounded-2xl ">
